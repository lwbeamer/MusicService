...
- Проверка подписки (не так важно можешь не срочно)
- Получить n последних плейлистов (тоже самое что и с альбомами)
- я кидаю сонг айди и юзер айди а ты в ответ есть ли у этого пользователя в плейлисте этот трек
- мне минет (<b>СРОЧНО</b>!)
