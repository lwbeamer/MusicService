...
- Получить имя артиста и его artist_id по user_id.

- При добавлении альбома я тебе кидаю имена артистов, которым принадлежит этот альбом. Возвращай id альбома:
    request :  
        {  
...
- При добавлении трека я кидаю имена артистов, которые на фите (по дефолту на этом треке те, чей альбом. featuresIds может быть и [] если на треке нет фита). Возвращай айди трека:
    request :  
        {   
...
- При добавлении трека в юхер плейлист проверять что его у него нет
- Убери с бэка изначальную дата базу с плейлистами которую мы не юзаем 
